  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="container mx-auto py-24 px-6 flex-grow text-center">
        <h1 className="text-4xl font-bold text-gray-800 mb-6">Industrie</h1>
        <p className="text-gray-600 mb-12">
          Optimisation de la production, maintenance prédictive et logistique intelligente grâce à l’IA et la Data Science.
        </p>
